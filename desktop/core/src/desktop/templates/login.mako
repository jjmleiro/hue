...
<style type="text/css">
  @font-face {
    ...
    src: url("${ static('desktop/ext/fonts/isban/OpenSans-Light.ttf') }");
  }
  @font-face {
    font-family: OpenSansRegular;
    src: url("${ static('desktop/ext/fonts/isban/OpenSans-Regular.ttf') }");
  }
  @font-face {
    font-family: OpenSansSemiBold;
    src: url("${ static('desktop/ext/fonts/isban/OpenSans-Semibold.ttf') }");
  }
  @font-face {
    font-family: OpenSansBold;
    src: url("${ static('desktop/ext/fonts/isban/OpenSans-Bold.ttf') }");
  }
  ...
  #logo {
    ...
    margin-right: auto;
    margin-bottom: 10px;
    background: url("${ static('desktop/art/isban/logo-principal-white.png') }") 50% 2px no-repeat;
    width: 360px;
    height: 114px;
  }
  ...
  <tr>
    ...
    <td align="left">
      <div class="table-height">
        <img src="${ static('desktop/art/isban/fondo.png') }" height="100%" width="100%"/>
      </div>
    </td>
  </tr>
</table>
